...
#new implemented
find_industry<-function(industry_word_cat,cat_vector){
...
vector_find_industry<-function(industry_word_cat,test_cat){
  result_vector<-c()
  ...
  for(i in 1:m_row){
    ...
    result_vector[i]<-find_industry(industry_word_cat,cat_vector)
  }
  return(result_vector)
}
#find_industry(industry_word,wordmatrix("student"))
vector_find_industry(industry_word_cat,c("retail"))
cat_list
```
...
result_vector<-vector_find_industry(industry_word_cat,test_cat)
j<-0
for(i in 1:testsize){
